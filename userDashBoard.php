...
//end for annual
 ...
 //echo("<script>console.log('Week: " .weekOfMonth('2022-04-10') . "');</script>");
    ...
    function fetch_data($db, $tableName, $columns, $username){
     ...
     $username =  $_SESSION['username'];
     $query = "SELECT * FROM `usertask` WHERE `username` = '$username' ORDER BY taskCategory ASC;";
    //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
    //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
     $result = $db->query($query);
     if($result== true){ 
    ...
    //   $Department = $_SESSION['userDept'];
      ...
      $query = "SELECT * FROM `usertask` WHERE `username` = '$username' AND taskType = 'daily' ORDER BY username ASC;";
     //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
     //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
      $result = $db->query($query);
      if($result== true){ 
    ...
    //    $Department = $_SESSION['userDept'];
       ...
       $query = "SELECT * FROM `usertask` WHERE `username` = '$username'AND taskType = 'weekly' ORDER BY username ASC;";
      //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
      //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
       $result = $db->query($query);
       if($result== true){ 
    ...
    //    $Department = $_SESSION['userDept'];
       $username =  $_SESSION['username'];
       $query = "SELECT * FROM `usertask` WHERE `username` = '$username' AND taskType = 'monthly' ORDER BY username ASC;";
      //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
      //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
       $result = $db->query($query);
       if($result== true){ 
       ...
       function fetchDataProgAnnual($db, $tableName, $columns, $username){
        ...
        // $Department = $_SESSION['userDept'];
        $username =  $_SESSION['username'];
        $query = "SELECT * FROM `usertask` WHERE `username` = '$username' AND taskType = 'annual' ORDER BY username ASC;";
       //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
       //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
        $result = $db->query($query);
        if($result== true){ 
    ...
    //   $Department = $_SESSION['userDept'];
      ...
      $query = "SELECT * FROM `users` WHERE `userlevel` = 'PIC' AND `username` = '$username';";
     //  SELECT * FROM `usertask` ORDER BY taskCategory ASC;
     //  SELECT * FROM `usertask` WHERE `username` = 'cjorozo';
      $result = $db->query($query);
      if($result== true){ 
...
<!-- <div class="normal-container">
	<div class="smile-rating-container">
      ...
      <div>
        ...
        <form action="userDashBoard.php" method = "POST" style="width: 100%; padding: 0; border: 0;">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form action="userDashBoard.php" method = "POST" id="categoryForm" style="width: 100%; padding: 10px; border: 0;" >
 ...
 <?php
                ...
                <button type="submit" name="RemoveCategory" class="btn btn-danger" >Remove</button>
                                      ...
                                      <div class="modal fade" id="reasonModalUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       ...
                                       <form action="userDashBoard.php" method = "POST" id="updateStatusForm" style="width: 100%; padding: 10px; border: 0;" >
...
<ul class="nav nav-pills mb-3 d-flex justify-content-start" id="myTab" role="tablist" style="height: fit-content">
  ...
  <li class="nav-item ">
    <a class="nav-link <?php echo $MembersActive; ?>" id="pic-tab" data-toggle="tab" href="#PIC" role="tab" aria-controls="PIC" aria-selected="false">My Progress</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?php echo $SummaryActive; ?>" id="dept-tab" data-toggle="tab" href="#Dept" role="tab" aria-controls="Dept" aria-selected="false">Summary</a>
  </li>
</ul>
</div>
                                  ...
                                  foreach($period as $dt) {
                                   ...
                                   if($taskType == "daily"){
                                    ...
                                    //  $year = date("Y");
                                      ...
                                      // $selectUserTask1 = "SELECT * FROM finishedtask WHERE taskID = '$taskID' AND `month` = '$monthOfThisDate' AND `year` = '$yearOfThisDate' AND `week` = 'week $curr' ORDER BY `FinishedTaskID` DESC LIMIT 1 "; //old
