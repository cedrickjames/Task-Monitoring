...
$tableName="usertask";
 ...
 echo("<script>console.log('Week: " .weekOfMonth('2022-04-10') . "');</script>");
    ...
    //  $query = "SELECT * FROM `usertask` WHERE `taskType` = 'daily'  ORDER BY taskCategory ASC;";
     $query = "SELECT * FROM usertask INNER JOIN users ON usertask.username = users.username WHERE users.userlevel = 'Leader' AND usertask.taskType = 'daily' ORDER BY usertask.taskCategory ASC;";
...
">
      <div>
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item active">
                  <a class="nav-link" href="#">Leader's Daily</a>
                </li>
                <li class="nav-item ">
        ...
        <div class="modal fade" id="reasonModalUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       ...
                                       <form action="dailyAdmin.php" method = "POST" id="updateStatusForm" style="width: 100%; padding: 10px; border: 0;" >
                ...
                <div class="card_body">
                    <div class="row d-flex ">
                        ...
                        <div class="col-sm-4" style="padding: 0;">
                          ...
                          <form action="dailyAdmin.php" method = "POST" >
