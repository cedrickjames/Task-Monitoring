  ...
  //LINTEK
    ...
    <div>
        ...
        <div class="wrapper" style="background: linear-gradient(to right, rgb(22, 34, 42), rgb(58, 96, 115));">
            ...
            <div class="inner" style="width: 1200px; height: 520px; max-width: 1200px; border-radius: 60px">
               
                
                <form id="account-settings" action="addTaskAdmin.php" method = "POST" style="width: 1200px; padding: 10px;"  >
                    <!-- <h3>Register User</h3> -->
