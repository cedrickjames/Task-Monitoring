                            ...
                            ?>
                             <tr class="tableMain" style="height:50px; <?php
                              $dateforToday = date('Y-m-d');
                               ...
                               $taskType1 = $data['taskType']; //Update for October 2022
                                            ...
                                            <div class="modal-content">
                                             ...
                                             <div class="form-group" id="daysLateDiv">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="ActionInputwithLate"  minlength="30" id="getAction"></textarea>
                                                  </div>
                                                  <div class="form-group">
